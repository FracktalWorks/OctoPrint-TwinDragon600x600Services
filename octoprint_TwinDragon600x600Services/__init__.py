...
class TwinDragon600x600ServicesPlugin(octoprint.plugin.StartupPlugin,
    ...
    def get_update_information(self):
        return dict(
            octoprint_TwinDragon600x600Services=dict(
                ...
                type="github_release",
                user="FracktalWorks",
                repo="OctoPrint-TwinDragon600x600Services",
                current=self._plugin_version,

                # update method: pip
                pip="https://github.com/FracktalWorks/OctoPrint-TwinDragon600x600Services/archive/{target_version}.zip"
            )
        )
    ...
    '''
    def initialize(self):
        self.log_info("TwinDragon600x600 Services started")
    ...
    def get_assets(self):
        return dict(js=["js/TwinDragon600x600Services.js"])
...
__plugin_name__ = "TwinDragon600x600 Services"
...
def __plugin_load__():
    ...
    __plugin_implementation__ = TwinDragon600x600ServicesPlugin()
