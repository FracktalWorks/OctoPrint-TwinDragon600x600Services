$(function() {
    function JFSViewModel(parameters) {
        ...
        self.testStatus = function(data) {
            ...
            $.ajax("/plugin/TwinDragon600x600Services/status");
        ...
        self.showPopup = function(msg, msgType, hide=true){
            ...
            var data = {
                title: 'TwinDragon600x600 Services',
                text: msg,
                type: msgType,
                hide: hide
            };
        ...
        self.onBeforeBinding = function() {
            ...
            self.Config = self.VM_settings.settings.plugins.TwinDragon600x600Services;
        ...
        self.onDataUpdaterPluginMessage = function(plugin, data) {
            if (plugin != "TwinDragon600x600Services")
                return;
